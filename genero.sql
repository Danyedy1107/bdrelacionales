...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-04-2026 a las 17:12:32
...
(1, 'Sandbox', 'Minecraft-like'),
(2, 'Estrategia', 'ajedrez-like'),
(3, 'Aventura', 'Explora tu mundo y descubre');
...
--
ALTER TABLE `plataforma`
  ADD CONSTRAINT `plataforma_ibfk_1` FOREIGN KEY (`id_plataforma`) REFERENCES `videojuego_plataforma` (`id_plataforma`);

--
-- Filtros para la tabla `videojuego`
--
ALTER TABLE `videojuego`
  ADD CONSTRAINT `videojuego_ibfk_1` FOREIGN KEY (`id_juego`) REFERENCES `videojuego_plataforma` (`id_juego`);
COMMIT;
